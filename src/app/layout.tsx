...
export const metadata: Metadata = {
  title: "Vitalik - Counter-Strike 2's Most Legendary Player",
  description: "Experience the chaos of Vitalik, CS2's most entertaining player. Five iconic poems and legendary moments of gameplay that will make you laugh and cry.",
  keywords: "Counter-Strike 2, Vitalik, esports, gaming, humor, CS2",
  robots: {
    index: true,
    follow: true
  },
  metadataBase: new URL("https://vitalik-disaster.com"),
  alternates: {
    canonical: "https://vitalik-disaster.com"
  },
  openGraph: {
    title: "Vitalik - CS2's Most Legendary Disaster",
    description: "Just whistle and disaster appears. Vitalik's legendary Counter-Strike 2 moments immortalized.",
    type: "website",
    siteName: "Vitalik's Legendary Moments",
    url: "https://vitalik-disaster.com",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766158627972-6bwvf06k.jpg",
      alt: "Vitalik's iconic flash grenade moment"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Vitalik - Counter-Strike 2 Legend",
    description: "The most entertaining CS2 player ever. Experience pure chaos.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766158627972-6bwvf06k.jpg"]
  }
};
